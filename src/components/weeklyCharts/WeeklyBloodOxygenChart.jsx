...
const WeeklyBloodOxygenChart = () => {
  const bloodOxygenChart = {
    series: [
      {
        name: "SpO2",
        data: [95, 93, 100, 98, 95, 100, 98],
      },
    ],
    options: {
      chart: {
        ...
        toolbar: {
          ...
          export: {
            csv: {
              filename: `daily_blood_oxygen_level`, // Custom filename for the exported CSV
...
export default WeeklyBloodOxygenChart;
